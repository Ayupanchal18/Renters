...
/**
 * Premium Select Component with animated open/close
 * 
 * Features:
 * - Scale, opacity, y-translate animation on open/close
...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 opacity-50 transition-transform duration-160 ease-smooth" />
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Animation duration and easing - using data attributes for state-based timing
        "data-[state=open]:duration-160 data-[state=closed]:duration-160",
        "data-[state=open]:ease-smooth data-[state=closed]:ease-smooth",
