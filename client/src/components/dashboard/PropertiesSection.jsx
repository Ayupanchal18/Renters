...
const PropertyCard = React.memo(function PropertyCard({ 
    ...
    return (
        <div
            key={prop._id}
            className="group bg-card border border-border hover:border-primary/50 rounded-xl p-5 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
        >
            <div className="flex items-start justify-between">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-2 flex-1 min-w-0">
                                <h4 className="font-semibold text-foreground text-lg truncate pr-2">
                                    {prop.title}
                                </h4>
                ...
                <div className="relative">
                    ...
                    {activeDropdown === prop._id && (
                        <div className="absolute right-0 top-full mt-2 w-52 bg-card border border-border rounded-xl shadow-xl z-10 overflow-hidden">
                            <div className="py-1">
                                <Link
    ...
    return (
        <div className="bg-card rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden relative">
            ...
            <div className="p-6">
                ...
                {properties && properties.length > 0 && (
                    <div className="flex flex-wrap items-center gap-4 mb-6 p-4 bg-muted/50 rounded-xl border border-border/50">
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="text-sm bg-card border border-border rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-foreground"
                            >
