...
import { SlidersHorizontal, X, Sparkles, Home, Key, Map as MapIcon } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
                    ...
                    <div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-40">
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3 rounded-full bg-primary text-primary-foreground font-semibold shadow-lg hover:shadow-xl active:scale-95 transition-all duration-200 border border-primary/20 backdrop-blur-sm"
