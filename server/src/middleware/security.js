...
export const securityHeaders = (req, res, next) => {
    ...
    if (process.env.NODE_ENV === 'development') {
        res.setHeader('Content-Security-Policy',
            ...
            "connect-src 'self' ws: wss: https://api.bigdatacloud.net https://accounts.google.com https://oauth2.googleapis.com https://graph.facebook.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://nominatim.openstreetmap.org https://cdnjs.cloudflare.com https://res.cloudinary.com https://*.cloudinary.com; " +
        ...
        res.setHeader('Content-Security-Policy',
            ...
            "font-src 'self' https://fonts.gstatic.com; " +
            "img-src 'self' data: https: blob:; " +
            "connect-src 'self' https://api.bigdatacloud.net https://accounts.google.com https://oauth2.googleapis.com https://graph.facebook.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org https://nominatim.openstreetmap.org https://cdnjs.cloudflare.com https://res.cloudinary.com https://*.cloudinary.com; " +
            "frame-src 'self' https://maps.google.com https://www.google.com https://*.google.com https://www.openstreetmap.org https://*.openstreetmap.org https://accounts.google.com https://www.facebook.com; " +
            "worker-src 'self' blob:;"
        );
    }
